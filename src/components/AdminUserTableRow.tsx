...
const AdminUserTableRow = ({
  ...
  const handleViewMore = () => {
    try {
      ...
      // Store complete admin table row information in localStorage for real-time data display
      const tableRowData = {
        id: user.id,
        name: user.name,
        email: user.email,
        ...
        avatar: user.avatar,
        isFromManageAdmin: true, // Flag to indicate this comes from manage admin
      };
  ...
  return (
    <tr className="border-b border-gray-100 hover:bg-gray-50">
      ...
      <td className="px-1 py-4 text-black">{user.role}</td>
